...
- Identify key drivers of employee attrition by exploratory data analysis.
...
The workforce is 60% male (882 employees) and 40% female (588 employees). Employees range from 18 to 60, with an average age of 37. The majority (over 70%) are between 25 and 44, the prime working years, where career growth and stability are critical factors in retention.
